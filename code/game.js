...
var actorChars = {
  ...
  "y": Floater //behaves like coin for now
};
...
//change these to change the wobble
var coinWobbleSpeed = 10, coinWobbleDist = 0.07;
var floaterWobbleSpeed = 20, floaterWobbleDist = 0.1;

//coin wobble
Coin.prototype.act = function(step) {
  this.wobble += step * coinWobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * coinWobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};

//floater wobble
Floater.prototype.act = function(step) {
  this.wobble += step * floaterWobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * floaterWobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  var restartPos = new Vector(7,10);
  if(obstacle === "lava"){
    this.pos = restartPos;
  }
...
// add this for new actor type - what happens when player collides w it - have it disappear, change player location,
//change a variable to keep track of score, etc
Level.prototype.playerTouched = function(type, actor) {
  ...
  else if(type == "floater") { //floater does same as coin for now
    this.actors = this.actors.filter(function(other) {
      return other != actor;
    });
  }
